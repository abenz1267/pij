...
public interface TagMediaService {
    ...
    /**
     * Removes the connection between a given {@link Tag} entity and a given {@link Media} entity to remove Tags from a certain media file.
     *
    ...
    /**
     * Gets a List a List with {@link Tag} entities which are connected to a given {@link Media} entities.
     *
     * @param media the media entities.
